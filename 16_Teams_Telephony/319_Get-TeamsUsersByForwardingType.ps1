<#
.SYNOPSIS
    Teams Users By Forwarding Type

.DESCRIPTION
    Ruft Teams Users By Forwarding Type aus der Teams-Telefonie ab.

.NOTES
    File Name : 319_Get-TeamsUsersByForwardingType.ps1
    Author    : Kaffeeundcode
    Version   : 1.0
#>

param(
    [string]$OutputPath = "$PSScriptRoot/319_Get-TeamsUsersByForwardingType.csv",
    [int]$Top = 25,
    [switch]$SkipConnect
)
...
$Result = Group-TtByPath -Items (Get-TtCallingSettingsDataset) -Path "ForwardingType" -Label "ForwardingType"
