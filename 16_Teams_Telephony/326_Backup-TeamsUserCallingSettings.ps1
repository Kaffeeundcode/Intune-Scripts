<#
.SYNOPSIS
    Teams User Calling Settings

.DESCRIPTION
    Sichert Teams User Calling Settings aus der Teams-Telefonie.

.NOTES
    File Name : 326_Backup-TeamsUserCallingSettings.ps1
    Author    : Kaffeeundcode
    Version   : 1.0
#>

param(
    [string]$OutputPath = "$PSScriptRoot/326_Backup-TeamsUserCallingSettings.json",
    [int]$Top = 25,
    [switch]$SkipConnect
)
...
$Result = Get-TtCallingSettingsDataset
