...
.DESCRIPTION
    Ruft Teams Voice Route Inventory aus der Teams-Telefonie ab.

.NOTES
    File Name : 257_Get-TeamsVoiceRouteInventory.ps1
    Author    : Kaffeeundcode
    Version   : 1.0
#>

param(
    [string]$OutputPath = "$PSScriptRoot/257_Get-TeamsVoiceRouteInventory.csv",
    [int]$Top = 25,
    [switch]$SkipConnect
)
