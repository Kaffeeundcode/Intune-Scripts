<#
.SYNOPSIS
    Teams Users With Unanswered To Voicemail

.DESCRIPTION
    Identifiziert Teams Users With Unanswered To Voicemail in der Teams-Telefonie.

.NOTES
    File Name : 322_Find-TeamsUsersWithUnansweredToVoicemail.ps1
    Author    : Kaffeeundcode
    Version   : 1.0
#>

param(
    [string]$OutputPath = "$PSScriptRoot/322_Find-TeamsUsersWithUnansweredToVoicemail.csv",
    [int]$Top = 25,
    [switch]$SkipConnect
)
...
$dataset = @(Get-TtCallingSettingsDataset | Where-Object { [string](Get-TtProp -InputObject $_ -Path "UnansweredTargetType") -match "Voicemail" })
