<#
.SYNOPSIS
    Teams Users By Call Group Configuration

.DESCRIPTION
    Ruft Teams Users By Call Group Configuration aus der Teams-Telefonie ab.

.NOTES
    File Name : 318_Get-TeamsUsersByCallGroupConfiguration.ps1
    Author    : Kaffeeundcode
    Version   : 1.0
#>

param(
    [string]$OutputPath = "$PSScriptRoot/318_Get-TeamsUsersByCallGroupConfiguration.csv",
    [int]$Top = 25,
    [switch]$SkipConnect
)
...
$Result = Group-TtByPath -Items (Get-TtCallingSettingsDataset) -Path "CallGroupTargets.Count" -Label "CallGroupTargetCount"
