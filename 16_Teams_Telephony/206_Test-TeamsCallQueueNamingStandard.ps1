<#
.SYNOPSIS
    Teams Call Queue Naming Standard

.DESCRIPTION
    Prueft Teams Call Queue Naming Standard in der Teams-Telefonie.

.NOTES
    File Name : 206_Test-TeamsCallQueueNamingStandard.ps1
    Author    : Kaffeeundcode
    Version   : 1.0
#>

param(
    [string]$OutputPath = "$PSScriptRoot/206_Test-TeamsCallQueueNamingStandard.csv",
    [int]$Top = 25,
    [switch]$SkipConnect
)
