<#
.SYNOPSIS
    Teams Users Without Hosted Voicemail

.DESCRIPTION
    Identifiziert Teams Users Without Hosted Voicemail in der Teams-Telefonie.

.NOTES
    File Name : 155_Find-TeamsUsersWithoutHostedVoicemail.ps1
    Author    : Kaffeeundcode
    Version   : 1.0
#>

param(
    [string]$OutputPath = "$PSScriptRoot/155_Find-TeamsUsersWithoutHostedVoicemail.csv",
    [int]$Top = 25,
    [switch]$SkipConnect
)
