<#
.SYNOPSIS
    Teams Users With Unanswered Settings

.DESCRIPTION
    Identifiziert Teams Users With Unanswered Settings in der Teams-Telefonie.

.NOTES
    File Name : 317_Find-TeamsUsersWithUnansweredSettings.ps1
    Author    : Kaffeeundcode
    Version   : 1.0
#>

param(
    [string]$OutputPath = "$PSScriptRoot/317_Find-TeamsUsersWithUnansweredSettings.csv",
    [int]$Top = 25,
    [switch]$SkipConnect
)
...
$dataset = @(Get-TtCallingSettingsDataset | Where-Object { [bool](Get-TtProp -InputObject $_ -Path "IsUnansweredEnabled") })
