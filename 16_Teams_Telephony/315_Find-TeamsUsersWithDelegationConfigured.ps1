<#
.SYNOPSIS
    Teams Users With Delegation Configured

.DESCRIPTION
    Identifiziert Teams Users With Delegation Configured in der Teams-Telefonie.

.NOTES
    File Name : 315_Find-TeamsUsersWithDelegationConfigured.ps1
    Author    : Kaffeeundcode
    Version   : 1.0
#>

param(
    [string]$OutputPath = "$PSScriptRoot/315_Find-TeamsUsersWithDelegationConfigured.csv",
    [int]$Top = 25,
    [switch]$SkipConnect
)
