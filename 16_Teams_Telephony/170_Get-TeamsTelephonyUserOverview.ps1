<#
.SYNOPSIS
    Teams Telephony User Overview

.DESCRIPTION
    Ruft Teams Telephony User Overview aus der Teams-Telefonie ab.

.NOTES
    File Name : 170_Get-TeamsTelephonyUserOverview.ps1
    Author    : Kaffeeundcode
    Version   : 1.0
#>

param(
    [string]$OutputPath = "$PSScriptRoot/170_Get-TeamsTelephonyUserOverview.csv",
    [int]$Top = 25,
    [switch]$SkipConnect
)
